var player1= prompt("Player One--->Enter your name:Your Color will be blue")
var player1Color='rgb(86,151,255)';
var player2= prompt("Player Two--->Enter your name:Your Color will be red")
...
$('.board button').on('click',function() {
  ...
  if (horzWinCheck() || vertWinCheck() || diagWinCheck()) {
      $('h3').fadeOut('fast');
      $('h2').fadeOut('fast');
